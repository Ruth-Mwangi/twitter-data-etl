...
from fetch_youtube_data import fetch_top_10_most_popular_youtube_videos
import pendulum
from airflow.models.dag import DAG
from airflow.operators.python import PythonOperator

from save_youtube_data import save_youtube_data
from process_youtube_data import process_youtube_data

spark = SparkSession.builder.appName("YoutubeSentimentAnalysis").config("spark.driver.memory", "8g").getOrCreate()
